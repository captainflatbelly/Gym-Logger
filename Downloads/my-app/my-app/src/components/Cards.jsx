        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white'>
                ...
                <div className='flex justify-center'>
                    <button className='bg-[#00df9a] w-[200px] hover:scale-105 duration-1000 mt-4 py-3 font-medium text-white rounded-md'>Subscribe</button>
                </div>
            </div>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white'>
                ...
                <div className='flex justify-center'>
                    <button className='bg-[#ffcc00] w-[200px] hover:scale-105 duration-1000 mt-4 py-3 font-medium text-black rounded-md'>Subscribe</button>
                </div>
            </div>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 bg-white'>
                ...
                <div className='flex justify-center'>
                    <button className='bg-[#ff7f50] w-[200px] hover:scale-105 duration-1000 mt-4 py-3 font-medium text-white rounded-md'>Subscribe</button>
                </div>
            </div>
        </div>
    </div>
